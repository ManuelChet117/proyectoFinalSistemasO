...
namespace administradorTareas
{
    public partial class FormPrincipal : Form
    {
        ...
        private void CloseForms(object sender,FormClosedEventArgs e)
        {
            ...
            btnWindows.BackColor = Color.FromArgb(4,41,68);

            if (Application.OpenForms["Form2"] == null)
                btnHardware.BackColor = Color.FromArgb(4, 41, 68);

            if (Application.OpenForms["Form3"] == null)
                btnMonitorear.BackColor = Color.FromArgb(4, 41, 68);

            if (Application.OpenForms["Form1"] == null)
                btnRedes.BackColor = Color.FromArgb(4, 41, 68);
